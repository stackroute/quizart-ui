          ...
          <Col xs={10} sm={10} md={8} lg={6}>
           ...
           <br />
             ...
             />
              ...
              //   <br />
              //   <TextField
              //     floatingLabelText="DurationInMins"
              //     value={this.state.durationInMins}
              //     onChange={e => this.setState({ name: e.target.value })}/>
              //   <TextField ref='secs'
              //     floatingLabelText="DurationInSecs"
              //     value={this.state.DurationInSecs}
              //     onChange={e => this.setState({ name: e.target.value })}/>
              //   <br />
              //   <TextField
              //     floatingLabelText="Score For RightAnswer"  value={this.state.right}
              //     onChange={e => this.setState({ name: e.target.value })}
              //     />
              //   <br />
              //   <TextField
              //     floatingLabelText="Score For WrongAnswer"  value={this.state.wrong}
              //     onChange={e => this.setState({ name: e.target.value })}
              //      />
              //   <br />
              //   <input type="file" />
